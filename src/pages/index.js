       ...
       <main>
        <section className="grid grid-cols-2 min-h-screen">
          <div className='py-24 px-16 flex flex-col justify-center gap-8'>
            ...
            <Button text='Start Here' link='start-here' />
          </div>
          ...
          <div className='grid grid-cols-2 gap-8'>
          {
            posts.map((post) => {
              return (
                ...
                <CaseStudyGridItemHome key={post.uri} post={post} />
              )
            })
          }
          </div>
        ...
        <section className='grid grid-cols-2'>
          <div className='cursor-pointer relative pb-[66%] flex justify-center items-center'>
